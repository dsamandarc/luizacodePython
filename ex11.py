# 11)This program will calculate the area of a square. 
# Ask the person to enter the numerical measurement of one side of the square. 
# AND then tell it the value of the area of the square.
